...
#-one for all values of the target features
...
couples_of_values = {"all_values": {"df": df,
                                    ...
                                    "figureFileName": 'Decision_Tree_Leiden.png',
                                    "featImpFileName": 'New_Feature_importances_Decision_Tree_Leiden.csv',
                                    },
                     "values_0_2": {"df": df[df['leiden'].isin([0, 2])],
                                    ...
                                    "featImpFileName": 'New_Feature_importances_Decision_Tree_0_2.csv',
                                    },
                     "values_2_3": {"df": df[df['leiden'].isin([2, 3])],
                                    ...
                                    "featImpFileName": 'New_Feature_importances_Decision_Tree_2_3.csv',
                                    },
                     "values_3_4": {"df": df[df['leiden'].isin([3, 4])],
                                    "dt": DecisionTreeClassifier(max_depth=2, criterion='gini', random_state=1),
                                    "figureTitle": 'Decision Tree Leiden 3_4',
                                    "figureFileName": 'Decision_Tree_Leiden_3_4.pdf',
                                    "featImpFileName": 'New_Feature_importances_Decision_Tree_3_4.csv',
                                    }
                     }
...
for element, model in couples_of_values.items():
    ...
    plt.title(title)
    plt.tight_layout()
    file_name = model["figureFileName"]
